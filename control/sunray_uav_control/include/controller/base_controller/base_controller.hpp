...
#include <controller_data_types/controller_desired_types.hpp>
...
class Px4LocalControl{
	public:
	EIGEN_MAKE_ALIGNED_OPERATOR_NEW
	explicit Px4LocalControl(ros::NodeHandle &nh); // 控制器的构造函数使用ros句柄，从ros参数空间中读取参数
	~Px4LocalControl() = default;
	...
	controller_data_types::Px4LocalControlResult calculateControl(const controller_data_types::FlatTrajectoryPoint &des,const sunray_common::QuadStateEstimate &odom);
